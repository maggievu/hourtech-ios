//
//  MessageSummaryViewController.swift
//  HourTech
//
//  Created by Noppawit Hansompob on 21/3/2562 BE.
...
class MessageSummaryViewController: UIViewController {
...
extension MessageSummaryViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cell = tableView.dequeueReusableCell(withIdentifier: "messageCell", for: indexPath) as? MessageSummaryTableViewCell {
